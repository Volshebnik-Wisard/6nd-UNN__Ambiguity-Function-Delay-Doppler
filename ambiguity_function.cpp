...
// ambiguity_function.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cambiguity_functionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Cambiguity_functionApp

Cambiguity_functionApp::Cambiguity_functionApp()
{
...
// Единственный объект Cambiguity_functionApp

Cambiguity_functionApp theApp;


// Инициализация Cambiguity_functionApp

BOOL Cambiguity_functionApp::InitInstance()
{
